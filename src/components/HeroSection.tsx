...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-dark-500 via-dark-400/95 to-dark-300/90 z-10"></div>
      
      {/* Silhouette image in background */}
      ...
      {/* Hero content */}
      <div className="hero-content container mx-auto px-4 md:px-6 z-20 pt-20 pb-10 sm:pb-20">
        <motion.div
      ...
      {/* Removed scroll down indicator for a cleaner look */}
    </section>
  );
}